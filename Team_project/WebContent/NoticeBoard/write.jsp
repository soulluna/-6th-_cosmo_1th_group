    ...
    <div class="fullWrap">
        ...
        <div class="wjdduf">
            <div class="wjddu">
                ...
                <div class="logo">
                    <a herf="MainPage.html"><img src="../Team2_kim/img/logo3.gif"></a>
                </div>

                <div class="zmrl">
                    <textarea class="noresize" name="contents" placeholder="내용을 입력해주세요."></textarea>
                </div>
                <div class="gkeks">
                    ...
                    <div class="rksrur_bottom_right">
                        <button><a href="#">임시저장</a></button>
                        <button class="make"><a href="#">작성하기</a></button>
                    </div>
                </div>
            </div>
        </div>
