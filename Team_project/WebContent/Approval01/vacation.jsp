					...
					<table>
						...
						<tr>
							<td>
								...
								<span>
									<input type="radio" name="leaveradio" value="연차" class="modifySelect1" id="kindsSelect1" checked="checked">
						...
						<tr>
							<td>
								...
								<input type="text" id="datepicker1" name="datepicker1" placeholder="년/월/일" readonly style="height: 35px;">
								~
								<input type="text" id="datepicker2" name="datepicker2" placeholder="년/월/일" readonly style="height: 35px;">
								(
						...
						<tr>
							<td>
								...
								<textarea class="inputContent" name="reason" placeholder="사유을 입력해주세요." required maxlength="1000"></textarea>
							</td>
						</tr>
					</table>
