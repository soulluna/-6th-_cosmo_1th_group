	      ...
	      try {
	          ...
	          if(action!=null && action.equals("/listArticles.do")) {
	         	...
	         	boardservice.addArticle(boardVO);
	              ...
	              boardVO=boardservice.viewArticle(Integer.parseInt(num));//article번호를 읽어와서 boardService에 viewArticle함수를 요청
	              request.setAttribute("details", boardVO);//가져온 결과값을 보내줌
	              nextPage="/WebContent/NoticeBoard/noticeBoardMain.do";//결과페이지를 이동하기 위해 nextPage에 경로 지정
